  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "bg-muted/80 text-foreground border border-border/80 shadow-2xs hover:bg-muted hover:text-foreground active:scale-95",
        showLabel ? "h-7 px-2.5 text-xs font-semibold" : "h-7 w-7 rounded-md",
        className,
      )}
