...
// Settings
export type Framework = "HTML" | "Tailwind";
...
export interface PluginSettings extends HTMLSettings, TailwindSettings {
  framework: Framework;
...
export type DownloadProjectFormat = "html" | "nextjs" | "vite";
