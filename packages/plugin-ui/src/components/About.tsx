    ...
    <div className="flex flex-col p-5 gap-6 text-sm max-w-2xl mx-auto">
      ...
      <div className="flex flex-col items-center text-center mb-2">
        ...
        <div className="flex items-center gap-1 text-neutral-500 dark:text-neutral-400">
          ...
          <span>by Kowshik Valipireddy</span>
        </div>
        <div className="mt-3 flex gap-3">
          <a
            href="https://github.com/kowshik3383/figma-to-code-plugin"
            target="_blank"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
        ...
        <Card className="border-border bg-card shadow-xs py-0 transition-all duration-150 hover:border-foreground/20">
          <CardContent className="p-4">
            ...
            <p className="text-muted-foreground text-xs leading-relaxed mb-3">
              Figma to Code is completely open-source (GPL-3.0). Contributions,
        ...
        <Card className="border-border bg-card shadow-xs py-0 transition-all duration-150 hover:border-foreground/20">
          <CardContent className="p-4">
            ...
            <div>
              <a
                href="https://github.com/kowshik3383/figma-to-code-plugin/issues"
                target="_blank"
                rel="noopener noreferrer"
      ...
      <footer className="mt-1 text-center text-muted-foreground/70 text-[11px]">
        <p>
          © {new Date().getFullYear()} Kowshik Valipireddy. Original © Bernardo
          Ferrari. GPL-3.0 open source software.
        </p>
      </footer>
    </div>
  );
